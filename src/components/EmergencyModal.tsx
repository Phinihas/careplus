...
export const EmergencyModal: React.FC<EmergencyModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/75 backdrop-blur-sm animate-in fade-in">
      <div className="bg-white rounded-3xl shadow-2xl border border-rose-200 max-w-lg w-full overflow-hidden text-slate-800">
        
        {/* Header Banner */}
        <div className="bg-gradient-to-r from-rose-800 via-red-700 to-rose-900 p-6 text-white relative">
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          <div className="bg-rose-50 border border-rose-200 rounded-2xl p-4 text-center">
            <span className="text-xs text-rose-800 font-bold uppercase tracking-wider block">
              National Ambulance & Trauma Dispatch
            </span>
            <a
              href="tel:108"
              className="inline-flex items-center gap-2 text-2xl sm:text-3xl font-black text-rose-700 hover:text-rose-800 mt-1 cursor-pointer"
            >
              <PhoneCall className="w-6 h-6 animate-bounce" />
              <span>108 / 1066</span>
            </a>
            <p className="text-xs text-rose-700 mt-1 font-semibold">Hospital Emergency Direct: +91 40 2345 6789</p>
            <p className="text-[11px] text-slate-500 mt-0.5">Average ICU Ambulance Response in Metro: ~7 minutes</p>
          </div>
          ...
          <div className="space-y-3 text-xs text-slate-600">
            <div className="flex items-start gap-3 p-3 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <div>
                <strong className="text-slate-800 block text-xs">Emergency Bay & Trauma Ramp:</strong>
            ...
            <div className="flex items-start gap-3 p-3 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <div>
                <strong className="text-slate-800 block text-xs">Immediate Triage Capabilities:</strong>
            ...
            <div className="flex items-start gap-3 p-3 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <div>
                <strong className="text-slate-800 block text-xs">National Poison Info Centre (AIIMS):</strong>
